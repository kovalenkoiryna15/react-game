...
const ShipSVG = ({
  player, value, userBoard, color,
}) => {
  let classes = `ship-svg ${value !== HERE_IS_FIRE ? '' : 'fired'}`;
  if (userBoard !== player) {
  ...
  return (
    <svg className={classes} viewBox="200 150 400 300" preserveAspectRatio="xMidYMid meet">
      ...
      <g className="radialGroup">
        <g opacity="0.6" fill={`${value !== HERE_IS_FIRE ? color : '#F70048'}`}>
        ...
        <g opacity="0.4" fill={`${value !== HERE_IS_FIRE ? color : '#F70048'}`}>
        ...
        <g opacity="0.15" fill={`${value !== HERE_IS_FIRE ? color : '#F70048'}`}>
        ...
        <g opacity="0.05" fill={`${value !== HERE_IS_FIRE ? color : '#F70048'}`}>
      ...
      <g className="icon">
        <use xlinkHref="#ring" stroke={`${value !== HERE_IS_FIRE ? color : '#F70048'}`} fill="none" className="ring" />
      </g>
      <use
        xlinkHref="#hitRing"
        stroke="none"
...
ShipSVG.propTypes = {
  ...
  userBoard: PropTypes.number.isRequired,
